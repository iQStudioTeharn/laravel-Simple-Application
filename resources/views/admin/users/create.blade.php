...
@section('content')
   ...
   @include('includes.form-errors')
    ...
    {!! Form::open(['method'=>'POST','action'=>'AdminUsersController@store','files'=>true,'class'=>"uk-grid-small ",'uk-grid']) !!}
        ...
        <div class="uk-margin uk-width-1-1">
            <div class=" uk-inline uk-width-1-1">
                ...
                {!! Form::password('password', ['placeholder'=>'password','class'=>'uk-input']) !!}
            </div>
        </div>
